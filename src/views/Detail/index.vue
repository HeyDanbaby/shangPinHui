<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-show="pageCategoryView.category1Name">{{
          pageCategoryView.category1Name
        }}</span>
        <span v-show="pageCategoryView.category2Name">{{
          pageCategoryView.category2Name
        }}</span>
        <span v-show="pageCategoryView.category3Name">{{
          pageCategoryView.category3Name
        }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="(spuSaleAttr, index) in pageSpuSaleAttrList"
                :key="spuSaleAttr.id"
              >
                <dt class="title">{{ spuSaleAttr.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: spuSaleAttrValue.isChecked == 0 }"
                  v-for="(
...
export default {
  ...
  computed: {
    ...mapGetters(["pageCategoryView", "pageSkuInfo", "pageSpuSaleAttrList"]),
